...
public class KMedoidesRandom {
	...
	public List<List<Double>> centrosIniciales(int cantCentros, List<List<Double>> registrosNormalizados) {
		...
		// es el m�dulo y determina el rango de valores que puede generar el algoritmo.
		// El valor de m debe ser un n�mero primo grande para obtener buenos resultados.
		// El per�odo m�ximo del generador (es decir, el n�mero m�ximo de valores que
		// puede generar antes de repetirse) es m.
		long m = (long) Math.pow(2, 32);

		// es el multiplicador y determina c�mo cambia la semilla en cada iteraci�n del
		// algoritmo. El valor de a debe ser un n�mero entero entre 0 y m. La elecci�n
		// de a afecta las propiedades estad�sticas de la secuencia de n�meros
		// generados.
		long a = 1664525;

		// es el incremento y se utiliza para evitar que el algoritmo genere ceros. El
		// valor de c debe ser un n�mero entero entre 0 y m. Si c es igual a 0, el
		...
		// n�meros pseudoaleatorios generados. El valor de seed debe ser un n�mero
		// entero entre 0 y m. Si se utiliza la misma semilla en diferentes ejecuciones
		// del algoritmo, se generar� la misma secuencia de n�meros pseudoaleatorios, por esso se utiliza el tiempo para hacerlo variar realmente.
